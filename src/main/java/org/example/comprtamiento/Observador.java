...
public class Observador {
    public void ejecutar() {
        ...
        CondicionesActuales climaActual = new CondicionesActuales(40,32,47);
        System.out.println(climaActual.toString());
        clima.registerObserver(climaActual);//Aqui el observador registra el clima actual
        clima.setMedidas(76,25,31);
...
class Clima implements Subject {
    ...
    public void medidasChanged() {
        System.out.println("Cambiaron las condiciones climaticas");
        notifyObservers();
    }
}

...
public class Builder {
    ...
    public void ejecutar() {
        System.out.println("_________________Builder Comida_________________________ ");

        Comida sandiwchCasa = new ComidaBuilder()
                .pan("Blanco")
                .lechuga("crespa")
                .queso("Doble crema")
                .carne("Cerdo")
                .build();
        System.out.println(sandiwchCasa.toString());

        Comida sandwishEspecial = new ComidaBuilder()
                .lechuga("Picada")
                .carne("Doble")
                .queso("Campesino")
                .ketchup("Poca")
